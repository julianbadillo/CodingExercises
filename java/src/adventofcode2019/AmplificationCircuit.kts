...
//val program = File("../data/adventofcode2019/intcode2.txt").readText().split(",").map{it.toInt()}.toIntArray()
//val phases = intArrayOf(4,3,2,1,0)
