from adventofcode2021.advent_day1 import *


def test_read_file():
    expected = [199, 200, 208, 210, 200, 207, 240, 269, 260, 263]
    actual = read_file("./data/adventofcode2021/advent_day1_test.txt")
...
def test_all_part1():
    input = read_file("./data/adventofcode2021/advent_day1.txt")
    expected = 1532
    actual = larger_than_prev(input)
    assert expected == actual
