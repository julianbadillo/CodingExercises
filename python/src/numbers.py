for i in range(0, 1000):
    ...
    if (
        ...
        or s[1] == "4"
        or s[2] == "7"
        or s.count("1") + s.count("4") + s.count("7") != 1
    ):
        continue
    # 1 8 9 tiene un digito en el lugar correto
    if (s[0] != "1" and s[1] != "8" and s[2] != "9") or s.count("1") + s.count(
        "8"
    ) + s.count("9") != 1:
        continue
    ...
    if (
        ...
        or s[1] == "6"
        or s[2] == "4"
        or s.count("9") + s.count("6") + s.count("4") != 2
    ):
        continue
    ...
    if (
        ...
        or s[1] == "8"
        or s[2] == "6"
        or s.count("2") + s.count("8") + s.count("6") != 1
    ):
        continue
    print(s)
